...
# from ragas.metrics.collections import faithfulness, answer_relevancy, context_precision, context_recall, context_entity_recall
...
# metrics_init = [faithfulness(), answer_relevancy(), context_precision(), context_recall(), context_entity_recall(), answer_similarity(), answer_correctness()]
# answer_similarity = AnswerSimilarity(llm=ragas_llm)
